...
export async function calculateBonusRequest({
  ...
  const evidence = {
    ...
    montos_origen: bonuses.montos_origen,
    bono_fin_disponible_lista: ruleInput.bono_fin_venta_disponible,
    bono_fin_aplicable: ruleInput.bono_fin_venta,
    financiamiento_aplica: ruleInput.financiamiento_aplica,
    bono_cierre_lista: calculated.bono_cierre_lista,
    bono_cierre_residual: calculated.bono_cierre_residual,
    bono_cierre_efectivo: calculated.bono_cierre_efectivo,
    bono_cierre_source: calculated.bono_cierre_source,
  ...
  await sql`
    UPDATE bonus_requests SET
      ...
      bono_cidef=${bonuses.bono_cidef}, bono_fin_venta=${ruleInput.bono_fin_venta},
      bono_cierre_venta=${calculated.bono_cierre_efectivo}, descuentos_dealer=${calculated.descuento_dealer_aprobado},
  ...
  return {
    ...
    ...bonuses,
    bono_fin_venta_disponible: ruleInput.bono_fin_venta_disponible,
    bono_fin_venta: ruleInput.bono_fin_venta,
    bono_cierre_venta: calculated.bono_cierre_efectivo,
    ...flags,
    ...calculated,
