...
export async function persistFinanciamientoExtraction(extraction) {
  ...
  const rows = await sql`
    INSERT INTO bonus_financiamiento_extractions (
      tenant_id, file_id, source_filename, documento_valido, vin, marca, modelo, version, financiera,
      ...
      ${extraction.tenant_id}, ${extraction.file_id}, ${extraction.source_filename ?? null}, ${extraction.documento_valido},
